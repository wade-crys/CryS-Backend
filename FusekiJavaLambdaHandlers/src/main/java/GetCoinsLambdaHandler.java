...
public class GetCoinsLambdaHandler implements RequestStreamHandler{
    ...
    public String getCoins(Long limit, String searchString, String format) {
        ...
        String filter = String.format("    FILTER (regex(?name, \"%s\", \"i\") || regex(?symbol, \"%s\", \"i\")) \n", searchString, searchString);
    ...
    public void handleRequest(InputStream inputStream, OutputStream outputStream, Context context) throws IOException {
        ...
        if (body == null)
            body = getCoins(limit, query, format);
    ...
    public static void main(String[] args) throws IOException {
        GetCoinsLambdaHandler handler = new GetCoinsLambdaHandler();
        InputStream is = new FileInputStream("test_get_coins.json");
